  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      ...
      <Paper elevation={3} sx={{ p: 3, mb: 4, display: 'flex', alignItems: 'center' }}>
        <Avatar
          src="/path-to-default-profile-image.jpg" // Replace with a default profile image
              ...
              <List>
                {payments.slice(0, 3).map((payment) => (
                  <React.Fragment key={payment.id}>
                    <ListItem alignItems="flex-start">
                      <ListItemAvatar>
                        <Avatar sx={{ bgcolor: 'primary.main' }}><PaymentIcon /></Avatar>
                      </ListItemAvatar>
                      <ListItemText
              ...
              <List>
                {notifications.slice(0, 3).map((notification) => (
                  <React.Fragment key={notification.id}>
                    <ListItem alignItems="flex-start">
                      <ListItemAvatar>
                        <Avatar sx={{ bgcolor: 'primary.main' }}><NotificationIcon /></Avatar>
                      </ListItemAvatar>
                      <ListItemText
